...
public abstract class AsyncTask<Params, Progress, Result> {
    ...
    public static final Executor DUAL_THREAD_EXECUTOR =
            Executors.newFixedThreadPool(CPU_CORE_NUMBER+1, sThreadFactory);

    public static final Executor DATABASE_THREAD_EXECUTOR =
            Executors.newFixedThreadPool(CPU_CORE_NUMBER+1, sThreadFactory);
    ...
    public enum Status {
        ...
        RUNNING,
        /**
         * Indicates that {@link net.bither.image.cache.AsyncTask#onPostExecute} has finished.
         */
        FINISHED,
    }
     ...
     *         {@link net.bither.image.cache.AsyncTask.Status#RUNNING} or {@link net.bither.image.cache.AsyncTask.Status#FINISHED}.
     *
