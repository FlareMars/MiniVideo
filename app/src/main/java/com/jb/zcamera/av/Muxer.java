...
public abstract class Muxer {
    ...
    private int mExpectedNumTracks = 2;           // TODO: Make this configurable?
    ...
    protected Muxer(String outputPath, FORMAT format, int expectedNumTracks){
        Log.i(TAG, "Created muxer for output: " + outputPath);
        mOutputPath = ZCameraUtil.checkNotNull(outputPath);
        mFormat = format;
        mNumTracks = 0;
    ...
    */
    ...
    public abstract void setLocation(float latitude, float longitude);
}
