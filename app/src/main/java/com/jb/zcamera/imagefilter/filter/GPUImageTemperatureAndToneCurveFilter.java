...
public class GPUImageTemperatureAndToneCurveFilter extends GPUImageFilter {
    ...
    public GPUImageTemperatureAndToneCurveFilter() {
        this(5000.0f, 0.0f);
    }

    public GPUImageTemperatureAndToneCurveFilter(final float temperature, final float tint) {
        ...
        mRgbCompositeControlPoints = new PointF[]{new PointF(0.0f, 0.0f), new PointF(0.3f, 0.3f), new PointF(0.4f, 0.4f), new PointF(1.0f, 1.0f)};
    ...
    public void setCurve(final float temperature) {
    	...
    	secondPointF.y = 0.15f + temperature;
    	
    	PointF thirdPointF = mRgbCompositeControlPoints[2];
    	thirdPointF.y = 0.25f + temperature;
