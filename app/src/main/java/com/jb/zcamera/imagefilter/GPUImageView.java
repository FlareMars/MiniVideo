...
public class GPUImageView extends FrameLayout {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        mGPUImage = new GPUImage(getContext(), false);
    ...
    public boolean onTouchEvent(MotionEvent event) {
        if (mGPUImage.hasEffect()) {
            return mGPUImage.onTouchEvent(event);
        }
...
//            setBackgroundColor(Color.BLACK);
    ...
    public void setSelectiveBlurEnable(boolean enable) {
        mGPUImage.setSelectiveBlurEnable(enable);
    }

    public boolean isSelectiveBlurEnable() {
        return mGPUImage.isSelectiveBlurEnable();
    }

    public void setTiltShiftEnable(boolean enable) {
        mGPUImage.setTiltShiftEnable(enable);
    }

    public boolean isTiltShiftEnable() {
        return mGPUImage.isTiltShiftEnable();
    }


    public void setSelectiveBlurSize(float value){
        mGPUImage.setSelectiveBlurSize(value);
    }

    public void setTiltShiftBlurSize(float value){
        mGPUImage.setTiltShiftBlurSize(value);
    }
}
