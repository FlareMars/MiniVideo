...
public class GPUImageWhiteBalanceAndToneCurveFilter extends GPUImageFilter {
	public static final String WHITE_BALANCE_FRAGMENT_SHADER = "" +
            ...
            "\n" +
            "	mediump vec3 processed = vec3(\n" +
            "		(rgb.r < 0.5 ? (2.0 * rgb.r * warmFilter.r) : (1.0 - 2.0 * (1.0 - rgb.r) * (1.0 - warmFilter.r))), //adjusting temperature\n" +
            "		(rgb.g < 0.5 ? (2.0 * rgb.g * warmFilter.g) : (1.0 - 2.0 * (1.0 - rgb.g) * (1.0 - warmFilter.g))), \n" +
            "		(rgb.b < 0.5 ? (2.0 * rgb.b * warmFilter.b) : (1.0 - 2.0 * (1.0 - rgb.b) * (1.0 - warmFilter.b))));\n" +
            "\n" +
            "	gl_FragColor = vec4(mix(rgb, processed, temperature), source.a);\n" +
            "     mediump vec4 textureColor = vec4(gl_FragColor);\n" +
    ...
    public GPUImageWhiteBalanceAndToneCurveFilter() {
        this(4900.0f, 0.0f);
    }
    
    public GPUImageWhiteBalanceAndToneCurveFilter(final float temperature, final float tint) {
        ...
        mRgbCompositeControlPoints = new PointF[]{new PointF(0.0f, 0.0f), new PointF(0.3f, 0.45f), new PointF(0.4f, 0.55f), new PointF(1.0f, 1.0f)};
        mRedControlPoints = new PointF[]{new PointF(0.0f, 0.0f), new PointF(0.5f, 0.5f), new PointF(1.0f, 1.0f)};
        mGreenControlPoints = new PointF[]{new PointF(0.0f, 0.0f), new PointF(1.0f, 1.0f)};
        mBlueControlPoints = new PointF[]{new PointF(0.0f, 0.0f), new PointF(1.0f, 1.0f)};
    }
    ...
    public void setCurve(final float temperature) {
    	PointF secondPointF = mRgbCompositeControlPoints[1];
    	secondPointF.y = 0.3f + temperature;
    	
    	PointF thirdPointF = mRgbCompositeControlPoints[2];
    	thirdPointF.y = 0.4f + temperature;
