...
import static com.jb.zcamera.imagefilter.GPUImageRenderer.CUBE;
...
public class GPUImageFilterGroup extends GPUImageFilter {
    ...
    public void setRotation(Rotation rotation, boolean flipHorizontal, boolean flipVertical) {
        ...
        if (mMergedFilters != null && mMergedFilters.size() > 0) {
            ...
            for (int i = 0; i < size; i++) {
                GPUImageFilter filter = mMergedFilters.get(i);
                if (filter != null) {
                    filter.setRotation(rotation, flipHorizontal, flipVertical);
                }
            }
        }
    }
    ...
    public void setFlipHorizontal(boolean flipHorizontal) {
        ...
        if (mMergedFilters != null && mMergedFilters.size() > 0) {
            ...
            for (int i = 0; i < size; i++) {
                GPUImageFilter filter = mMergedFilters.get(i);
                if (filter != null) {
                    filter.setFlipHorizontal(flipHorizontal);
                }
            }
        }
    }
    ...
    public void setFlipVertical(boolean flipVertical) {
        ...
        if (mMergedFilters != null && mMergedFilters.size() > 0) {
            ...
            for (int i = 0; i < size; i++) {
                GPUImageFilter filter = mMergedFilters.get(i);
                if (filter != null) {
                    filter.setFlipVertical(flipVertical);
                }
            }
        }
    }
    ...
    protected void runOnDraw(Runnable runnable) {
        if (mMergedFilters != null && mMergedFilters.size() > 0) {
            mMergedFilters.get(0).runOnDraw(runnable);
        }
    }
}
